...
void ImGui::ShowComboAutoSelectDemo(bool* p_open)
{
    ...
    if (ImGui::Begin("ComboAutoSelect Demo", p_open, ImGuiWindowFlags_AlwaysAutoResize)) {
        ...
        if (ImGui::ComboAutoSelect("std::vector combo", inputbuf1, 128, selected_item1, items1, item_getter1, ImGuiComboInputTextFlags_HeightSmall)) {
            /* Selection made */
        }
        ...
        if (ImGui::ComboAutoSelect("std::array combo", inputbuf2, 128, selected_item2, items2, item_getter2, autoselect_callback, ImGuiComboInputTextFlags_HeightLarge)) {
            /* Selection made */
        }
        ...
        if (ImGui::ComboAutoSelect("Combo 6", combo_data1, ImGuiComboInputTextFlags_HeightLarge)) {
            /* Selection made */
        }
        ...
        if (ImGui::ComboAutoSelect("Combo 7", combo_data3, ImGuiComboInputTextFlags_NoArrowButton)) {
            /* Selection made */
        }
        ...
        if (ImGui::ComboAutoSelect("Combo 8", combo_data4, ImGuiComboInputTextFlags_HeightSmall)) {
            /* Selection made */
        }
        ...
        if (ImGui::ComboAutoSelect("Combo 10", combo_data5, ImGuiComboInputTextFlags_NoPreview)) {
            /* Selection made */
        }
    }
    ImGui::End();
...
void ImGui::ShowComboFilterDemo(bool* p_open)
{
    ...
    if (ImGui::Begin("ComboFilter Demo", p_open, ImGuiWindowFlags_AlwaysAutoResize)) {
        ...
        if (ImGui::ComboFilter("Combo Filter 1", combo_data1, ImGuiComboInputTextFlags_HeightSmall)) {
            /* Selection made */
        }
        ...
        if (ImGui::ComboFilter("Combo Filter 2", combo_data2, ImGuiComboInputTextFlags_NoArrowButton)) {
            /* Selection made */
        }
        ...
        if (ImGui::ComboFilter("Combo Filter 3", combo_data3, ImGuiComboInputTextFlags_HeightLargest)) {
            /* Selection made */
        }

        static ImGui::ComboFilterData combo_data4(std::vector<std::string>(), item_getter1, filter_callback);
        if (ImGui::ComboFilter("Combo Filter 4", combo_data4, ImGuiComboInputTextFlags_NoPreview)) {
            /* Selection made */
        }
