...
void ComboAutoSelectDemo()
{
    if (ImGui::Begin("ComboAutoSelect Demo", nullptr, ImGuiWindowFlags_AlwaysAutoResize)) {
        ...
        if (ImGui::ComboAutoSelect("std::array combo", selected_item2, items2, item_getter2, fuzzy_search, ImGuiComboFlags_HeightLarge)) {
            /* Selection made */
        }
        ...
        if (ImGui::ComboAutoSelect("empty combo", selected_item4, items4, item_getter2, fuzzy_search)) {
            /* Selection made */
        }
    }
	ImGui::End();
